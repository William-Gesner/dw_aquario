"""
Conferência DIM_REPRESENTANTE (Prata) x USU_VBIREPRESENTANTES (legado,
...
PRÉ-REQUISITO: GRANT SELECT ON BIAQUARIO.USU_VBIREPRESENTANTES TO DW_PRATA;

Uso:
    python -m conferencias.conferencia_dim_representante
"""
...
TABELA_PRATA = "DIM_REPRESENTANTE"

SCHEMA_LEGADO = "BIAQUARIO"
TABELA_LEGADO = "USU_VBIREPRESENTANTES"

COLUNAS = [
    "CODREP", "DOCREP", "NOMEREP", "APEREP", "TIPOREP", "SITREP",
    "CODRAMO", "RAMO", "CIDADE", "ESTADO", "TELEFONE", "EMAIL",
    "ID_REGIONAL", "NOME_REGIONAL", "DT_CADASTRO",
]
