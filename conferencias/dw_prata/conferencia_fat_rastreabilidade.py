"""
Conferência FAT_RASTREABILIDADE (Prata) x USU_VBIARAST_RASTREABILIDADE
...
Nenhuma coluna nova foi adicionada nesta migração -- todas as colunas do
legado são comparadas.

PRÉ-REQUISITO: GRANT SELECT ON BIAQUARIO.USU_VBIARAST_RASTREABILIDADE TO DW_PRATA;

Uso:
    python -m conferencias.dw_prata.conferencia_fat_rastreabilidade
"""
...
TABELA_PRATA = "FAT_RASTREABILIDADE"

SCHEMA_LEGADO = "BIAQUARIO"
TABELA_LEGADO = "USU_VBIARAST_RASTREABILIDADE"

# Mesmas colunas nos dois lados -- ver vbirastreabilidade.py (legado) e
# fat_rastreabilidade.py (Prata nova).
COLUNAS = [
    "NUMNFV", "NUMPED", "CODPRO", "DESPRO", "QTDFAT", "CODCLI", "CODREP",
    "DATEMI", "NOMCLI", "APECLI", "TIPCLI", "SIGUFS", "CIDCLI", "CODRAM",
    "NOMREP", "APEREP", "TIPREP", "CANREP", "DESRAM", "CODBAR", "DATGER",
    "CODFOR", "NOMFOR", "NUMOCP", "NUMINV", "NUMNFC", "DATOCP", "DATEMB",
    "DATEMINFC", "DATENTNFC", "MIX", "ORIGEM",
]
