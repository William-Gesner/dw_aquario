"""
Conferência DIM_PRODUTO_PRODUCAO (Prata) x USU_VBIAPROD_PRODUTO (legado,
...
PRÉ-REQUISITO: GRANT SELECT ON BIAQUARIO.USU_VBIAPROD_PRODUTO TO DW_PRATA;

Uso:
    python -m conferencias.dw_prata.conferencia_dim_produto_producao
"""
...
TABELA_PRATA = "DIM_PRODUTO_PRODUCAO"

SCHEMA_LEGADO = "BIAQUARIO"
TABELA_LEGADO = "USU_VBIAPROD_PRODUTO"

COLUNAS = [
    "CODEMP", "CODPRO", "DESPRO", "CODDER", "CODFAM", "DESFAM", "UNIMED",
    "TIPPRO", "CODORI", "CODAGE", "CODAGT", "DESAGP", "SITPRO", "CURABC",
    "DEPPAD", "USU_INDFDL",
]
