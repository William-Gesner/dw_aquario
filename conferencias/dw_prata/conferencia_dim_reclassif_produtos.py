"""
Conferência DIM_RECLASSIF_PRODUTOS (Prata) x USU_VBIARMA_RECLASSIF_PRODUTOS
...
ATENÇÃO: o script de extração (dim_reclassif_produtos.py) só inclui
CD_SIT_INDICADOR_2/DS_SIT_INDICADOR_2 SE essas colunas existirem na aba
ClassifProdutos do Excel no momento da carga (rename condicional). Se a
tabela real (Prata e legado) não tiver essas 2 colunas, remova-as de
COLUNAS abaixo antes de rodar -- senão a query quebra com ORA-00904.

PRÉ-REQUISITO: GRANT SELECT ON BIAQUARIO.USU_VBIARMA_RECLASSIF_PRODUTOS TO DW_PRATA;

Uso:
    python -m conferencias.dw_prata.conferencia_dim_reclassif_produtos
"""
...
TABELA_PRATA = "DIM_RECLASSIF_PRODUTOS"
...
# As 2 últimas são condicionais -- ver ATENÇÃO no docstring.
COLUNAS = [
    "CD_PRODUTO", "CD_PRODUTO_NOVO", "CD_CLASSIF_PROD", "DS_CLASSIF_PROD",
    "CD_SIT_INDICADOR", "DS_SIT_INDICADOR",
    "CD_SIT_INDICADOR_2", "DS_SIT_INDICADOR_2",
]
