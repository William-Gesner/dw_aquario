"""
Conferência DIM_PRODUTO (Prata) x USU_BVIPRODUTOS (legado, schema
...
PRÉ-REQUISITO: GRANT SELECT ON BIAQUARIO.USU_BVIPRODUTOS TO DW_PRATA;

Uso:
    python -m conferencias.conferencia_dim_produto
"""
...
TABELA_PRATA = "DIM_PRODUTO"

SCHEMA_LEGADO = "BIAQUARIO"
TABELA_LEGADO = "USU_BVIPRODUTOS"

COLUNAS = [
    "CATEGORIAID", "CATEGORIA", "CHAVE_ITEM", "CODITEM", "DESCITEM",
    "CODNCM", "CODEAN", "CODCEST", "PERIPI", "SITITEM", "FORALINHA",
    "COMPRIMENTO", "ALTURA", "LARGURA", "PESOBRUTO", "PESOLIQ",
]
