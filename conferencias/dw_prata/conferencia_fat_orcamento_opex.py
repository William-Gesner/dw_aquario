"""
Conferência FAT_ORCAMENTO_OPEX (Prata) x USU_VBIAOPEX_ORCAMENTO (legado,
...
Todas as colunas do legado são comparadas (nenhuma coluna nova foi
adicionada nesta migração, diferente do FAT_FATURAMENTO).

PRÉ-REQUISITO: GRANT SELECT ON BIAQUARIO.USU_VBIAOPEX_ORCAMENTO TO DW_PRATA;

Uso:
    python -m conferencias.dw_prata.conferencia_fat_orcamento_opex
"""
...
TABELA_PRATA = "FAT_ORCAMENTO_OPEX"

SCHEMA_LEGADO = "BIAQUARIO"
TABELA_LEGADO = "USU_VBIAOPEX_ORCAMENTO"

# Mesmas colunas nos dois lados -- ver vbiopex.py (legado) e
# fat_orcamento_opex.py (Prata nova).
COLUNAS = [
    "EMP", "COMP", "CC", "CDESP", "ORCADO", "REALIZADO", "CCUSTO", "TPCC",
    "DESPESA", "PROD", "CODDONO", "DONO", "QUARTER", "CODCOORD", "COORD",
]
