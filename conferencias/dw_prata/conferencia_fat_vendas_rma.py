"""
Conferência FAT_VENDAS_RMA (Prata) x USU_VBIARMA_VENDAS (legado, schema
...
PRÉ-REQUISITO: GRANT SELECT ON BIAQUARIO.USU_VBIARMA_VENDAS TO DW_PRATA;

Uso:
    python -m conferencias.dw_prata.conferencia_fat_vendas_rma
"""
...
COLUNAS = [
    "TIPREG", "DATREF", "DATFIM", "DATINI", "CODEMP", "CODPRO", "QTDMED",
    "VENDA_MES_ANO_PRODUTO",
]
