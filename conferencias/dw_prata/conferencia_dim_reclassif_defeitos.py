"""
Conferência DIM_RECLASSIF_DEFEITOS (Prata) x USU_VBIARMA_RECLASSIF_DEFEITOS
...
Colunas com espaço/acento (ex.: "NOVO CÓDIGO") vêm direto do cabeçalho
do Excel (aba DescDefeitos) -- precisam de aspas duplas no Oracle pra
preservar caixa e caracteres especiais. Se a tabela real na VM tiver
nomes de coluna diferentes do que está listado aqui (o Excel pode ter
sido editado desde a última vez que este levantamento foi feito),
ajustar COLUNAS antes de rodar.

PRÉ-REQUISITO: GRANT SELECT ON BIAQUARIO.USU_VBIARMA_RECLASSIF_DEFEITOS TO DW_PRATA;

Uso:
    python -m conferencias.dw_prata.conferencia_dim_reclassif_defeitos
"""
...
TABELA_PRATA = "DIM_RECLASSIF_DEFEITOS"
...
# Nomes entre aspas duplas porque vêm do cabeçalho do Excel (com espaço/acento).
COLUNAS = [
    '"PRODUTO"', '"CÓDIGO"', '"NOVO CÓDIGO"', '"NOVO DEFEITO"', '"PROD_COD_DEF"',
]
