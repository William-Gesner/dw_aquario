"""
Conferência FAT_METAS (Prata) x USU_VBIMETAS (legado, schema BIAQUARIO)
-- compara os DADOS, não só a contagem.
...
PRÉ-REQUISITO: GRANT SELECT ON BIAQUARIO.USU_VBIMETAS TO DW_PRATA;

Uso:
    python -m conferencias.conferencia_fat_metas
"""
...
TABELA_PRATA = "FAT_METAS"

SCHEMA_LEGADO = "BIAQUARIO"
TABELA_LEGADO = "USU_VBIMETAS"

COLUNAS = [
    "CODEMP", "MESANO", "CODTIP", "SEQREG", "DESC_TIPO", "CODCRI",
    "DESC_CRITERIO", "UNICRI", "DESC_UNICRI", "DIRCRI", "DESC_DIRCRI",
    "CODRVR", "NOME_REGIONAL", "CODREP", "NOME_REP", "CODAGP",
    "DESC_MIX", "CODPRO", "DESC_PRODUTO", "VLR_META", "PESO_CRITERIO",
    "DT_CRIACAO", "USUARIO",
]
