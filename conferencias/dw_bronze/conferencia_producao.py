...
Comercial/Laudos RMA. Só compara as tabelas de TABELAS_DESTE_BLOCO
(extrator.py) -- as 4 compartilhadas com o Comercial não entram aqui, já
são validadas pela conferência do Comercial.
...
conferência dedicada ao levar pra VM, junto com os das outras áreas):
    python -m producao.bronze.conferencia
"""
...
from producao.bronze.extrator import TABELAS_DESTE_BLOCO, montar_query_pks
