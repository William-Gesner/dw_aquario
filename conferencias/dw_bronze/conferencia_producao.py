"""
Conferência Bronze x Sapiens -- Produção.
...
anterior tinha os mesmos 2 pontos cegos:
    ...
    a) Contagem usava o MESMO filtro (tem_codemp/tem_codfil) do catálogo
       pros dois lados -- então o bug de tem_codfil=True em E210MVP/
       E621MTC/E900COP/E930MPR (corrigido em 17/07/2026, ver
       producao/bronze/tabelas.py) nunca teria aparecido aqui.
...
Uso:
    python -m conferencias.dw_bronze.conferencia_producao
        -> contagem (rápida) nas tabelas do catálogo.

    python -m conferencias.dw_bronze.conferencia_producao --conteudo E900COP
...
if __name__ == "__main__":
    ...
    if "--conteudo" in sys.argv:
        ...
        try:
            ...
            print("  Uso: python -m conferencias.dw_bronze.conferencia_producao --conteudo NOME_TABELA")
            sys.exit(1)
