...
TABELAS_DESTE_BLOCO (extrator.py) -- as 7 compartilhadas com o Comercial
e a 1 compartilhada com o Laudos RMA não entram aqui, já são validadas
pela conferência de cada uma dessas áreas.
...
conferência dedicada ao levar pra VM, junto com os das outras áreas):
    python -m rastreabilidade.bronze.conferencia
"""
...
from rastreabilidade.bronze.extrator import TABELAS_DESTE_BLOCO, montar_query_pks
from rastreabilidade.bronze.tabelas import buscar_tabela
from rastreabilidade.config.settings import schema_bronze
