"""
Carregamento e exposição das variáveis de ambiente do módulo Estoque.

Mesmo servidor Oracle do Comercial/Produção/Laudos RMA (não precisa de
credencial separada, diferente do OPEX) -- usa core.db.get_engine()
normalmente.
...
# Detecta a raiz do projeto (3 níveis acima: settings.py -> config -> estoque -> raiz)
